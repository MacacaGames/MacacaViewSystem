...
namespace MacacaGames.ViewSystem
{
    public abstract class ViewControllerBase : MonoBehaviour
    {
        ...
        public Coroutine ShowOverlayViewPage(string viewPageName, bool RePlayOnShowWhileSamePage = false, Action OnStart = null, Action OnChanged = null, Action OnComplete = null, bool ignoreTimeScale = false, bool ignoreClickProtection = false, RectTransform customRoot = null, bool createPageCanvas = false, params object[] models)
        {
            if (!CheckTimeProtect())
            {
            ...
            return StartCoroutine(ShowOverlayViewPageBase(nextOverlayViewPage, RePlayOnShowWhileSamePage, OnStart, OnChanged, OnComplete, ignoreTimeScale, ignoreClickProtection, customRoot, createPageCanvas, models));
        }
        ...
        public virtual IEnumerator ShowOverlayViewPageBase(ViewPage vp, bool RePlayOnShowWhileSamePage, Action OnStart, Action OnChanged, Action OnComplete, bool ignoreTimeScale = false, bool ignoreClickProtection = false, RectTransform customRoot = null, bool createPageCanvas = false, params object[] models)
        {
